...
#define DECLARE(id) cmocka_unit_test_setup_teardown(id, Setup, Teardown)
const struct CMUnitTest alltests[] = {
    DECLARE(test_default_session_does_not_timeout),
    DECLARE(test_programming_session_times_out),
    DECLARE(test_0x10_no_fn_results_in_negative_resp),
    DECLARE(test_0x10_no_fn_results_in_negative_resp_functional),
    DECLARE(test_0x10_suppress_pos_resp),
    DECLARE(test_0x11_no_send_after_ECU_reset),
    DECLARE(test_0x14_positive_response),
    DECLARE(test_0x14_incorrect_request_length),
    DECLARE(test_0x14_negative_response),
    DECLARE(test_0x19_sub_0x01),
    DECLARE(test_0x19_sub_0x02),
    DECLARE(test_0x19_sub_0x02_no_matching_dtc),
    DECLARE(test_0x19_sub_0x03),
    DECLARE(test_0x19_sub_0x03_no_snapshots),
    DECLARE(test_0x19_sub_0x04),
    DECLARE(test_0x19_sub_0x04_no_records),
    DECLARE(test_0x19_sub_0x05),
    DECLARE(test_0x19_sub_0x05_no_data),
    DECLARE(test_0x19_sub_0x06),
    DECLARE(test_0x19_sub_0x06_no_data),
    DECLARE(test_0x19_sub_0x07),
    DECLARE(test_0x19_sub_0x08),
    DECLARE(test_0x19_sub_0x08_no_dtc),
    DECLARE(test_0x19_sub_0x09),
    DECLARE(test_0x19_sub_0x09_no_dtc),
    DECLARE(test_0x19_sub_0x0A),
    DECLARE(test_0x19_sub_0x0B),
    DECLARE(test_0x19_sub_0x0B_no_info),
    DECLARE(test_0x19_sub_0x0C),
    DECLARE(test_0x19_sub_0x0C_no_info),
    DECLARE(test_0x19_sub_0x0D),
    DECLARE(test_0x19_sub_0x0D_no_info),
    DECLARE(test_0x19_sub_0x0E),
    DECLARE(test_0x19_sub_0x0E_no_info),
    DECLARE(test_0x19_sub_0x14),
    DECLARE(test_0x19_sub_0x15),
    DECLARE(test_0x19_sub_0x15_no_data),
    DECLARE(test_0x19_sub_0x16),
    DECLARE(test_0x19_sub_0x16_no_record),
    DECLARE(test_0x19_sub_0x17),
    DECLARE(test_0x19_sub_0x17_no_matching_dtc),
    DECLARE(test_0x19_sub_0x18),
    DECLARE(test_0x19_sub_0x18_no_record),
    DECLARE(test_0x19_sub_0x19),
    DECLARE(test_0x19_sub_0x19_no_data),
    DECLARE(test_0x19_sub_0x1A),
    DECLARE(test_0x19_sub_0x1A_no_data),
    DECLARE(test_0x19_sub_0x42),
    DECLARE(test_0x19_sub_0x42_no_record),
    DECLARE(test_0x19_sub_0x55),
    DECLARE(test_0x19_sub_0x55_no_record),
    DECLARE(test_0x19_sub_0x56),
    DECLARE(test_0x19_sub_0x56_no_record),
    DECLARE(test_0x19_subfunc_not_suported),
    DECLARE(test_0x19_invalid_req_len),
    DECLARE(test_0x19_invalid_subFunction),
    DECLARE(test_0x19_shrink_default_response_len),
    DECLARE(test_0x19_malformed_responses),
    DECLARE(test_0x22),
    DECLARE(test_0x22_nonexistent),
    DECLARE(test_0x22_misuse),
    DECLARE(test_0x23),
    DECLARE(test_0x27_level_is_zero_at_init),
    DECLARE(test_0x27_unlock),
    DECLARE(test_0x27_brute_force_prevention_1),
    DECLARE(test_0x27_brute_force_prevention_2),
    DECLARE(test_0x28_comm_ctrl_example1),
    DECLARE(test_0x28_comm_ctrl_example2),
    DECLARE(test_0x28_comm_ctrl_invalid_request),
    DECLARE(test_0x28_comm_ctrl_forced_malformed_response_in_event_handler),
    DECLARE(test_0x2C_request_too_short),
    DECLARE(test_0x2C_sub_0x01),
    DECLARE(test_0x2C_sub_0x01_request_too_short),
    DECLARE(test_0x2C_sub_0x01_negative_response),
    DECLARE(test_0x2C_sub_0x02),
    DECLARE(test_0x2C_sub_0x02_request_malformed),
    DECLARE(test_0x2C_sub_0x02_request_too_short),
    DECLARE(test_0x2C_sub_0x02_negative_response),
    DECLARE(test_0x2C_sub_0x02_zero_address_and_length_format_identifier),
    DECLARE(test_0x2C_sub_0x03),
    DECLARE(test_0x2C_sub_0x03_clear_all),
    DECLARE(test_0x2C_sub_0x03_negative_response),
    DECLARE(test_0x2F_example),
    DECLARE(test_0x2F_incorrect_request_length),
    DECLARE(test_0x2F_negative_response),
    DECLARE(test_0x31_RCRRP),
    DECLARE(test_0x34_no_handler),
    DECLARE(test_0x34),
    DECLARE(test_0x38_no_handler),
    DECLARE(test_0x38_addfile),
    DECLARE(test_0x38_delfile),
    DECLARE(test_0x38_delfile_issue_116),
    DECLARE(test_0x3D_example_1),
    DECLARE(test_0x3D_example_2),
    DECLARE(test_0x3D_example_3),
    DECLARE(test_0x3e_suppress_positive_response),
    DECLARE(test_0x85_control_dtc_setting),
    DECLARE(test_0x85_control_dtc_setting_with_control_data),
    DECLARE(test_0x85_control_dtc_setting_request_too_short),
    DECLARE(test_0x85_control_dtc_setting_request_returns_negative_response),
    DECLARE(test_0x87_link_ctrl_sub_0x01),
    DECLARE(test_0x87_link_ctrl_sub_0x02),
    DECLARE(test_0x87_link_ctrl_negative_response),
    DECLARE(test_security_level_resets_on_session_timeout),
};
