...
void test_0x11_good_response(void **state) {
    Env_t *e = *state;
    MockServerAddBehavior(e->mock_server, &(struct Behavior){.tag = ExactRequestResponse,
...
void test_0x11_timeout(void **state) {
    Env_t *e = *state;
    MockServerAddBehavior(e->mock_server,
                          &(struct Behavior){.tag = ExactRequestResponse,
                                             .exact_request_response = {
                                                 .req_data = {0x11, 0x01},
                                                 .req_len = 2,
                                                 .resp_data = {0x51, 0x01},
...
void test_0x22_unpack_rdbi_response(void **state) {
    ...
    uint16_t var = 0;
    UDSRDBIVar_t vars[] = {{0xf190, 2, &var, memmove}};
...
void test_0x38_format_add_file(void **state) {
    ...
    const uint8_t CORRECT_REQUEST[] = {0x38, 0x01, 0x00, 0x12, 0x2F, 0x64, 0x61, 0x74, 0x61, 0x2F,
...
void test_0x2e_issue_59(void **state) {
    ...
    MockServerAddBehavior(e->mock_server, &(struct Behavior){.tag = TimedSend,
                                                             .timed_send = {
